...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230331123613_initial')
BEGIN
...
BEGIN
    ...
    VALUES (N'20230331123613_initial', N'6.0.1');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230331140214_seedauthors')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230331140214_seedauthors', N'6.0.1');
END;
GO
